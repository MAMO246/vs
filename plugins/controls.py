...
async def player(client, message):
    ...
    if not Config.CALL_STATUS:
        ...
        await message.reply_text(
            ...
            "Player is idle, start the player using below button. уЕдуЕдуЕдуЕд",
...
async def skip_track(_, m: Message):
    ...
    msg=await m.reply('╪м╪з╪▒ ╪к╪о╪╖┘К ╪з┘Д┘Б┘К╪п┘К┘ИуА╜я╕П....')
    ...
    if not Config.playlist:
        ...
        await msg.edit("╪╣╪░╪▒╪з┘Л ┘В╪з╪ж┘Е╪й ╪з┘Д╪к╪┤╪║┘К┘Д ┘Б╪з╪▒╪║╪йтЭЧ")
...
async def pause_playing(_, m: Message):
    ...
    if not Config.CALL_STATUS:
        ...
        await m.reply_text(
            ...
            "Player is idle, start the player using below button. уЕдуЕдуЕдуЕдуЕд",
...
async def set_vol(_, m: Message):
    ...
    if not Config.CALL_STATUS:
        ...
        await m.reply_text(
            ...
            "Player is idle, start the player using below button. уЕдуЕдуЕдуЕдуЕдуЕд",
    ...
    if len(m.command) < 2:
        ...
        await m.reply_text('Change Volume of Your VCPlayer. уЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕд', reply_markup=await volume_buttons())
    ...
    if not 1 < int(m.command[1]) < 200:
        ...
        await m.reply_text(f"Only 1-200 range is accepeted. уЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕд", reply_markup=await volume_buttons())

    else:

        await volume(int(m.command[1]))

        await m.reply_text(f"Succesfully set volume to {m.command[1]} уЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕд", reply_markup=await volume_buttons())
...
async def set_mute(_, m: Message):
    ...
    if not Config.CALL_STATUS:
        ...
        await m.reply_text(
            ...
            "Player is idle, start the player using below button. уЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕд",
    ...
    if k:
        ...
        k = await m.reply_text(f" ЁЯФЗ Succesfully Muted ")
...
async def set_unmute(_, m: Message):
    ...
    if k:
        ...
        k = await m.reply_text(f"ЁЯФК ╪к┘Е╪к ╪з╪╣╪з╪п╪й ╪з┘Д╪╡┘И╪к ╪и┘Ж╪м╪з╪нуА╜я╕П ")
...
async def show_player(client, m: Message):
    ...
    if not data.get('dur', 0) or \
        ...
        title="<b>Playing Live Stream</b> уЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕд"

    else:

        if Config.playlist:

            title=f"<b>{Config.playlist[0][1]}</b> уЕдуЕдуЕдуЕд\n уЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕд"

        elif Config.STREAM_LINK:

            title=f"<b>Stream Using [Url]({data['file']}) </b> уЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕд"

        else:

            title=f"<b>Streaming Startup [stream]({Config.STREAM_URL})</b> уЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕд"
...
async def seek_playout(client, m: Message):
    ...
    if not Config.CALL_STATUS:
        ...
        await m.reply_text(
            ...
            "Player is idle, start the player using below button. уЕдуЕдуЕд уЕдуЕд",
    ...
    k=await m.reply("╪м╪з╪▒ ┘Е╪н╪з┘И┘Д╪й ╪з┘Д╪к┘В╪п┘К┘ЕтЪЩя╕П..")
    ...
    if ' ' in m.text:
        ...
        if not data.get('dur', 0)\
            ...
            title="<b>Playing Live Stream</b> уЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕд"

        else:

            if Config.playlist:

                title=f"<b>{Config.playlist[0][1]}</b>\nуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕд"

            elif Config.STREAM_LINK:

                title=f"<b>Stream Using [Url]({data['file']})</b> уЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕд"
        ...
        Config.msg['player'] = await k.edit(f"ЁЯО╕{title}", reply_markup=await get_buttons(), disable_web_page_preview=True)
...
async def settings(client, m: Message):
    ...
    await m.reply(f"╪│┘И┘Б ╪к╪м╪п ┘З┘Ж╪з ╪з╪╣╪п╪з╪п╪з╪к ╪з┘Д╪к╪н┘Г┘Е ╪и╪з┘Д╪и┘И╪к ╪з┘Д╪о╪з╪╡ ╪и┘Г. уЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕдуЕд", reply_markup=await settings_panel(), disable_web_page_preview=True)
